...
from faculty_wear import init_faculty_wear_routes

from sponsored_ads import init_sponsored_ads_module
...
init_users_routes(app, db, get_wat_time, STATUS_CONFIG)

init_faculty_wear_routes(app, db)
